                  ...
                  <li v-for="person in team" :key="person.handle" class="px-6 py-5 relative">
                    <div class="group flex justify-between items-center">
                      ...
                      <Menu as="div" class="ml-2 relative inline-block text-left">
                        ...
                        <TransitionRoot as="template" enter="transition ease-out duration-100" enter-from="transform opacity-0 scale-95" enter-to="transform opacity-100 scale-100" leave="transition ease-in duration-75" leave-from="transform opacity-100 scale-100" leave-to="transform opacity-0 scale-95" :show="undefined">
                          <MenuItems static class="origin-top-right absolute z-10 top-0 right-9 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                            <div class="py-1">
